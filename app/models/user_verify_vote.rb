class UserVerifyVote < ActiveRecord::Base
  attr_accessible :idhash, :doc_key, :vote_idhash, :vote_doc_key, :vote_verify_level
  ...
  def complex_id
    UserVerifyVote.complex_id(vote_idhash, vote_doc_key)
  end
