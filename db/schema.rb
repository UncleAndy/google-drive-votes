...
ActiveRecord::Schema.define(:version => 20140127124417) do
  ...
  create_table "trust_net_members", :force => true do |t|
    ...
    t.string   "doc_key_type", :limit => 32,  :default => "GOOGLEDOC"
  end
  ...
  create_table "user_verify_votes", :force => true do |t|
    ...
    t.string   "doc_key",           :limit => 64,                          :null => false
    t.string   "doc_key_type",      :limit => 32, :default => "GOOGLEDOC"
    t.string   "vote_doc_key_type", :limit => 32, :default => "GOOGLEDOC"
  end
